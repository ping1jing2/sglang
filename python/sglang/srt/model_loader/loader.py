...
def _initialize_model(
    ...
    if _is_npu:
        packed_modules_mapping["visual"] = {}
        packed_modules_mapping["visual"]["qkv_proj"] = ["qkv"]
        packed_modules_mapping["model"] = {}
        packed_modules_mapping["model"]["fused_qkv_a_proj_with_mqa"] = [
            "q_a_proj",
            "kv_a_proj_with_mqa",
        ]
        packed_modules_mapping["model"]["qkv_proj"] = ["q_proj", "k_proj", "v_proj"]
        packed_modules_mapping["model"]["gate_up_proj"] = ["gate_proj", "up_proj"]
